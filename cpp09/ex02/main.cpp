...
int main() {
    ...
    std::chrono::high_resolution_clock::time_point start = std::chrono::high_resolution_clock::now(); // Registrar el tiempo de inicio
    maker.mergeInShort();
    std::chrono::high_resolution_clock::time_point end = std::chrono::high_resolution_clock::now(); // Registrar el tiempo de finalización
